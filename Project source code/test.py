...
# Draw a blue line with specific width and position (adjust values as needed)
# line = customtkinter.CTkLabel(master=app, text="", bg_color="blue", width=50, height=0)
# line.place(x=245, y=60)  # Place the line at center
